/**
 * @file libpcp_unit_tests.c
 *
 * Novaprova unit tests for functions related to libpcp functions.
 * Must have Apteryx installed on the system running these tests
 * since libpcp heavily depends on it.
 *
